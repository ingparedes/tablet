...
<input type="text" data-table="userlevels" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" size="30" maxlength="4" placeholder="<?php echo HtmlEncode($userlevels_add->userlevelid->getPlaceHolder()) ?>" value="<?php echo $userlevels_add->userlevelid->EditValue ?>"<?php echo $userlevels_add->userlevelid->editAttributes() ?>>
</span>
