...
<input type="text" data-table="userlevels" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" size="30" maxlength="4" placeholder="<?php echo HtmlEncode($userlevels_edit->userlevelid->getPlaceHolder()) ?>" value="<?php echo $userlevels_edit->userlevelid->EditValue ?>"<?php echo $userlevels_edit->userlevelid->editAttributes() ?>>
