 ...
 * Page class
 */
class preh_servicio_ambulancia_delete extends preh_servicio_ambulancia
{
	...
	// Page object name
	public $PageObjName = "preh_servicio_ambulancia_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("preh_servicio_ambulancialist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("preh_servicio_ambulancialist.php"); // Return to list
			}
		}
	}
