 ...
 * Page class
 */
class turno_registro_delete extends turno_registro
{
	...
	// Page object name
	public $PageObjName = "turno_registro_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("turno_registrolist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("turno_registrolist.php"); // Return to list
			}
		}
	}
