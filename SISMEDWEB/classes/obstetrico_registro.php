...
/**
 * Table class for obstetrico_registro
 */
class obstetrico_registro extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'obstetrico_registro';
		$this->TableName = 'obstetrico_registro';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "\"obstetrico_registro\"";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('obstetrico_registro', 'obstetrico_registro', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 2, 2, -1, FALSE, '"id"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// cod_casopreh
		$this->cod_casopreh = new DbField('obstetrico_registro', 'obstetrico_registro', 'x_cod_casopreh', 'cod_casopreh', '"cod_casopreh"', 'CAST("cod_casopreh" AS varchar(255))', 3, 4, -1, FALSE, '"cod_casopreh"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// trabajoparto
		$this->trabajoparto = new DbField('obstetrico_registro', 'obstetrico_registro', 'x_trabajoparto', 'trabajoparto', '"trabajoparto"', '"trabajoparto"', 200, 1, -1, FALSE, '"trabajoparto"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->trabajoparto->Sortable = TRUE; // Allow sort
		$this->fields['trabajoparto'] = &$this->trabajoparto;

		// sangradovaginal
		$this->sangradovaginal = new DbField('obstetrico_registro', 'obstetrico_registro', 'x_sangradovaginal', 'sangradovaginal', '"sangradovaginal"', '"sangradovaginal"', 200, 1, -1, FALSE, '"sangradovaginal"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sangradovaginal->Sortable = TRUE; // Allow sort
		$this->fields['sangradovaginal'] = &$this->sangradovaginal;

		// g
		$this->g = new DbField('obstetrico_registro', 'obstetrico_registro', 'x_g', 'g', '"g"', '"g"', 200, 100, -1, FALSE, '"g"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->g->Sortable = TRUE; // Allow sort
		$this->fields['g'] = &$this->g;

		// p
		$this->p = new DbField('obstetrico_registro', 'obstetrico_registro', 'x_p', 'p', '"p"', '"p"', 200, 100, -1, FALSE, '"p"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->p->Sortable = TRUE; // Allow sort
		$this->fields['p'] = &$this->p;

		// a
		$this->a = new DbField('obstetrico_registro', 'obstetrico_registro', 'x_a', 'a', '"a"', '"a"', 200, 100, -1, FALSE, '"a"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->a->Sortable = TRUE; // Allow sort
		$this->fields['a'] = &$this->a;

		// n
		$this->n = new DbField('obstetrico_registro', 'obstetrico_registro', 'x_n', 'n', '"n"', '"n"', 200, 100, -1, FALSE, '"n"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->n->Sortable = TRUE; // Allow sort
		$this->fields['n'] = &$this->n;

		// c
		$this->c = new DbField('obstetrico_registro', 'obstetrico_registro', 'x_c', 'c', '"c"', '"c"', 200, 100, -1, FALSE, '"c"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->c->Sortable = TRUE; // Allow sort
		$this->fields['c'] = &$this->c;

		// fuente
		$this->fuente = new DbField('obstetrico_registro', 'obstetrico_registro', 'x_fuente', 'fuente', '"fuente"', '"fuente"', 200, 1, -1, FALSE, '"fuente"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fuente->Sortable = TRUE; // Allow sort
		$this->fields['fuente'] = &$this->fuente;

		// tiempo
		$this->tiempo = new DbField('obstetrico_registro', 'obstetrico_registro', 'x_tiempo', 'tiempo', '"tiempo"', '"tiempo"', 200, 100, -1, FALSE, '"tiempo"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "\"obstetrico_registro\"";
	}
	...
	public function insert(&$rs)
	{
		...
		if ($success) {
			...
			$this->id->setDbValue($conn->getOne("SELECT currval('obstetrico_registro_id_seq'::regclass)"));
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->trabajoparto->DbValue = $row['trabajoparto'];
		$this->sangradovaginal->DbValue = $row['sangradovaginal'];
		$this->g->DbValue = $row['g'];
		$this->p->DbValue = $row['p'];
		$this->a->DbValue = $row['a'];
		$this->n->DbValue = $row['n'];
		$this->c->DbValue = $row['c'];
		$this->fuente->DbValue = $row['fuente'];
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "obstetrico_registrolist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "obstetrico_registroedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "obstetrico_registroadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("obstetrico_registroview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("obstetrico_registroview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "obstetrico_registroadd.php?" . $this->getUrlParm($parm);
		else
			$url = "obstetrico_registroadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("obstetrico_registroedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("obstetrico_registroadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("obstetrico_registrodelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->trabajoparto->setDbValue($rs->fields('trabajoparto'));
		$this->sangradovaginal->setDbValue($rs->fields('sangradovaginal'));
	...
	public function renderEditRow()
	{
		...
		$this->trabajoparto->EditValue = $this->trabajoparto->CurrentValue;
		...
		$this->sangradovaginal->EditValue = $this->sangradovaginal->CurrentValue;
		...
		$this->fuente->EditValue = $this->fuente->CurrentValue;
