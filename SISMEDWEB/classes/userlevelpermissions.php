...
class userlevelpermissions extends DbTable
{
	...
	public function __construct()
	{
		...
		// userlevelid
		$this->userlevelid = new DbField('userlevelpermissions', 'userlevelpermissions', 'x_userlevelid', 'userlevelid', '"userlevelid"', 'CAST("userlevelid" AS varchar(255))', 3, 4, -1, FALSE, '"userlevelid"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// permission
		$this->permission = new DbField('userlevelpermissions', 'userlevelpermissions', 'x_permission', 'permission', '"permission"', 'CAST("permission" AS varchar(255))', 3, 4, -1, FALSE, '"permission"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
