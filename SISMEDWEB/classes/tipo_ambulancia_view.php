 ...
 * Page class
 */
class tipo_ambulancia_view extends tipo_ambulancia
{
	...
	// Page object name
	public $PageObjName = "tipo_ambulancia_view";
	...
	public function __construct()
	{
		...
		if (Get("id_tipotransport") !== NULL) {
			$this->RecKey["id_tipotransport"] = Get("id_tipotransport");
			$keyUrl .= "&amp;id_tipotransport=" . urlencode($this->RecKey["id_tipotransport"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_tipotransport") !== NULL) {
				...
				$this->RecKey["id_tipotransport"] = $this->id_tipotransport->QueryStringValue;
				...
				$this->RecKey["id_tipotransport"] = $this->id_tipotransport->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_tipotransport->setFormValue(Route(2));
				$this->RecKey["id_tipotransport"] = $this->id_tipotransport->FormValue;
			} else {
				$returnUrl = "tipo_ambulancialist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tipo_ambulancialist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tipo_ambulancialist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
