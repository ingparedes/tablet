 ...
 * Page class
 */
class explo_fisica_view extends explo_fisica
{
	...
	// Page object name
	public $PageObjName = "explo_fisica_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "explo_fisicalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "explo_fisicalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "explo_fisicalist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
