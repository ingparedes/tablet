...
class menu_caso
{
	...
	// Table name
	public $TableName = 'menu_caso.php';

	// Page object name
	public $PageObjName = "menu_caso";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'menu_caso.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "menu_caso", $url, "", "menu_caso", TRUE);
		$this->Heading = $Language->TablePhrase("menu_caso", "TblCaption"); 
	}
} // End class
?>