...
/**
 * Table class for ambulancias
 */
class ambulancias extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'ambulancias';
		$this->TableName = 'ambulancias';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "\"ambulancias\"";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id_ambulancias
		$this->id_ambulancias = new DbField('ambulancias', 'ambulancias', 'x_id_ambulancias', 'id_ambulancias', '"id_ambulancias"', 'CAST("id_ambulancias" AS varchar(255))', 2, 2, -1, FALSE, '"id_ambulancias"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id_ambulancias->IsAutoIncrement = TRUE; // Autoincrement field
		$this->id_ambulancias->IsPrimaryKey = TRUE; // Primary key field
		$this->id_ambulancias->IsForeignKey = TRUE; // Foreign key field
		$this->id_ambulancias->Nullable = FALSE; // NOT NULL field
		...
		// cod_ambulancias
		$this->cod_ambulancias = new DbField('ambulancias', 'ambulancias', 'x_cod_ambulancias', 'cod_ambulancias', '"cod_ambulancias"', '"cod_ambulancias"', 200, 16, -1, FALSE, '"cod_ambulancias"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cod_ambulancias->Nullable = FALSE; // NOT NULL field
		$this->cod_ambulancias->Required = TRUE; // Required field
		$this->cod_ambulancias->Sortable = TRUE; // Allow sort
		$this->fields['cod_ambulancias'] = &$this->cod_ambulancias;

		// placas
		$this->placas = new DbField('ambulancias', 'ambulancias', 'x_placas', 'placas', '"placas"', '"placas"', 200, 30, -1, FALSE, '"placas"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->placas->Sortable = TRUE; // Allow sort
		$this->fields['placas'] = &$this->placas;

		// chasis
		$this->chasis = new DbField('ambulancias', 'ambulancias', 'x_chasis', 'chasis', '"chasis"', '"chasis"', 200, 100, -1, FALSE, '"chasis"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->chasis->Sortable = TRUE; // Allow sort
		$this->fields['chasis'] = &$this->chasis;

		// marca
		$this->marca = new DbField('ambulancias', 'ambulancias', 'x_marca', 'marca', '"marca"', '"marca"', 200, 50, -1, FALSE, '"marca"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->marca->Sortable = TRUE; // Allow sort
		$this->fields['marca'] = &$this->marca;

		// modelo
		$this->modelo = new DbField('ambulancias', 'ambulancias', 'x_modelo', 'modelo', '"modelo"', '"modelo"', 200, 32, -1, FALSE, '"modelo"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modelo->Sortable = TRUE; // Allow sort
		$this->fields['modelo'] = &$this->modelo;

		// tipo_translado
		$this->tipo_translado = new DbField('ambulancias', 'ambulancias', 'x_tipo_translado', 'tipo_translado', '"tipo_translado"', 'CAST("tipo_translado" AS varchar(255))', 2, 2, -1, FALSE, '"tipo_translado"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->tipo_translado->Sortable = TRUE; // Allow sort
		$this->tipo_translado->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->tipo_translado->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		switch ($CurrentLanguage) {
			case "en":
				$this->tipo_translado->Lookup = new Lookup('tipo_translado', 'tipo_ambulancia', FALSE, 'id_tipotransport', ["tipo_amb_es","","",""], [], [], [], [], [], [], '', '');
				break;
			case "fr":
				$this->tipo_translado->Lookup = new Lookup('tipo_translado', 'tipo_ambulancia', FALSE, 'id_tipotransport', ["tipo_amb_es","","",""], [], [], [], [], [], [], '', '');
				break;
		...
		// tipo_conbustible
		$this->tipo_conbustible = new DbField('ambulancias', 'ambulancias', 'x_tipo_conbustible', 'tipo_conbustible', '"tipo_conbustible"', '"tipo_conbustible"', 200, 30, -1, FALSE, '"tipo_conbustible"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tipo_conbustible->Sortable = TRUE; // Allow sort
		$this->fields['tipo_conbustible'] = &$this->tipo_conbustible;

		// modalidad
		$this->modalidad = new DbField('ambulancias', 'ambulancias', 'x_modalidad', 'modalidad', '"modalidad"', 'CAST("modalidad" AS varchar(255))', 2, 2, -1, FALSE, '"modalidad"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		switch ($CurrentLanguage) {
			case "en":
				$this->modalidad->Lookup = new Lookup('modalidad', 'modalidad_ambulancia', FALSE, 'id_modalidad', ["modalidadambu_es","","",""], [], [], [], [], [], [], '', '');
				break;
			case "fr":
				$this->modalidad->Lookup = new Lookup('modalidad', 'modalidad_ambulancia', FALSE, 'id_modalidad', ["modalidadambu_es","","",""], [], [], [], [], [], [], '', '');
				break;
		...
		// estado
		$this->estado = new DbField('ambulancias', 'ambulancias', 'x_estado', 'estado', '"estado"', 'CAST("estado" AS varchar(255))', 2, 2, -1, FALSE, '"estado"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		switch ($CurrentLanguage) {
			case "en":
				$this->estado->Lookup = new Lookup('estado', 'ambulancias', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
			case "fr":
				$this->estado->Lookup = new Lookup('estado', 'ambulancias', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
		...
		$this->estado->OptionCount = 4;
		$this->estado->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['estado'] = &$this->estado;

		// ubicacion
		$this->ubicacion = new DbField('ambulancias', 'ambulancias', 'x_ubicacion', 'ubicacion', '"ubicacion"', '"ubicacion"', 200, 100, -1, FALSE, '"ubicacion"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->ubicacion->Sortable = TRUE; // Allow sort
		$this->ubicacion->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->ubicacion->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		switch ($CurrentLanguage) {
			case "en":
				$this->ubicacion->Lookup = new Lookup('ubicacion', 'base_ambulancia', FALSE, 'id_base', ["nombre","dpto","provincia","distrito"], [], [], [], [], [], [], '', '');
				break;
			case "fr":
				$this->ubicacion->Lookup = new Lookup('ubicacion', 'base_ambulancia', FALSE, 'id_base', ["nombre","dpto","provincia","distrito"], [], [], [], [], [], [], '', '');
				break;
		...
		// disponible
		$this->disponible = new DbField('ambulancias', 'ambulancias', 'x_disponible', 'disponible', '"disponible"', '"disponible"', 200, 2, -1, FALSE, '"disponible"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->disponible->Sortable = TRUE; // Allow sort
		$this->fields['disponible'] = &$this->disponible;

		// fecha_iniseguro
		$this->fecha_iniseguro = new DbField('ambulancias', 'ambulancias', 'x_fecha_iniseguro', 'fecha_iniseguro', '"fecha_iniseguro"', CastDateFieldForLike("\"fecha_iniseguro\"", 5, "DB"), 135, 8, 5, FALSE, '"fecha_iniseguro"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fecha_iniseguro->Sortable = TRUE; // Allow sort
		$this->fecha_iniseguro->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateYMD"));
		$this->fields['fecha_iniseguro'] = &$this->fecha_iniseguro;

		// fecha_finseguro
		$this->fecha_finseguro = new DbField('ambulancias', 'ambulancias', 'x_fecha_finseguro', 'fecha_finseguro', '"fecha_finseguro"', CastDateFieldForLike("\"fecha_finseguro\"", 5, "DB"), 135, 8, 5, FALSE, '"fecha_finseguro"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fecha_finseguro->Sortable = TRUE; // Allow sort
		$this->fecha_finseguro->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateYMD"));
		$this->fields['fecha_finseguro'] = &$this->fecha_finseguro;

		// entidad
		$this->entidad = new DbField('ambulancias', 'ambulancias', 'x_entidad', 'entidad', '"entidad"', '"entidad"', 200, 30, -1, FALSE, '"entidad"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->entidad->Sortable = TRUE; // Allow sort
		switch ($CurrentLanguage) {
			case "en":
				$this->entidad->Lookup = new Lookup('entidad', 'base_ambulancia', FALSE, 'id_base', ["nombre","dpto","provincia","distrito"], [], [], [], [], [], [], '', '');
				break;
			case "fr":
				$this->entidad->Lookup = new Lookup('entidad', 'base_ambulancia', FALSE, 'id_base', ["nombre","dpto","provincia","distrito"], [], [], [], [], [], [], '', '');
				break;
		...
		// observacion
		$this->observacion = new DbField('ambulancias', 'ambulancias', 'x_observacion', 'observacion', '"observacion"', '"observacion"', 200, 100, -1, FALSE, '"observacion"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->observacion->Sortable = TRUE; // Allow sort
		$this->fields['observacion'] = &$this->observacion;

		// asiganda
		$this->asiganda = new DbField('ambulancias', 'ambulancias', 'x_asiganda', 'asiganda', '"asiganda"', '"asiganda"', 200, 100, -1, FALSE, '"asiganda"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->asiganda->Sortable = TRUE; // Allow sort
		$this->fields['asiganda'] = &$this->asiganda;

		// config_manteni
		$this->config_manteni = new DbField('ambulancias', 'ambulancias', 'x_config_manteni', 'config_manteni', '"config_manteni"', '"config_manteni"', 200, 10, -1, FALSE, '"config_manteni"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->config_manteni->Sortable = TRUE; // Allow sort
		$this->fields['config_manteni'] = &$this->config_manteni;

		// fecha_creacion
		$this->fecha_creacion = new DbField('ambulancias', 'ambulancias', 'x_fecha_creacion', 'fecha_creacion', '"fecha_creacion"', CastDateFieldForLike("\"fecha_creacion\"", 5, "DB"), 135, 8, 5, FALSE, '"fecha_creacion"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fecha_creacion->Sortable = TRUE; // Allow sort
		$this->fecha_creacion->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateYMD"));
		$this->fields['fecha_creacion'] = &$this->fecha_creacion;

		// longitudambulancia
		$this->longitudambulancia = new DbField('ambulancias', 'ambulancias', 'x_longitudambulancia', 'longitudambulancia', '"longitudambulancia"', '"longitudambulancia"', 200, 30, -1, FALSE, '"longitudambulancia"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->longitudambulancia->Sortable = TRUE; // Allow sort
		$this->fields['longitudambulancia'] = &$this->longitudambulancia;

		// latituambulancia
		$this->latituambulancia = new DbField('ambulancias', 'ambulancias', 'x_latituambulancia', 'latituambulancia', '"latituambulancia"', '"latituambulancia"', 200, 30, -1, FALSE, '"latituambulancia"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->latituambulancia->Sortable = TRUE; // Allow sort
		$this->fields['latituambulancia'] = &$this->latituambulancia;

		// especial
		$this->especial = new DbField('ambulancias', 'ambulancias', 'x_especial', 'especial', '"especial"', 'CAST("especial" AS varchar(255))', 2, 2, -1, FALSE, '"especial"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->especial->Sortable = TRUE; // Allow sort
		$this->especial->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->especial->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		switch ($CurrentLanguage) {
			case "en":
				$this->especial->Lookup = new Lookup('especial', 'especial_ambulancia', FALSE, 'id_especialambulancia', ["especial_en","","",""], [], [], [], [], [], [], '', '');
				break;
			case "fr":
				$this->especial->Lookup = new Lookup('especial', 'especial_ambulancia', FALSE, 'id_especialambulancia', ["especial_es","","",""], [], [], [], [], [], [], '', '');
				break;
			case "pt":
				$this->especial->Lookup = new Lookup('especial', 'especial_ambulancia', FALSE, 'id_especialambulancia', ["especial_es","","",""], [], [], [], [], [], [], '', '');
				break;
	...
	public function getDetailUrl()
	{
		...
		// Detail url
		$detailUrl = "";
		if ($this->getCurrentDetailTable() == "mante_amb") {
			$detailUrl = $GLOBALS["mante_amb"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
			$detailUrl .= "&fk_id_ambulancias=" . urlencode($this->id_ambulancias->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "ambulanciaslist.php";
		return $detailUrl;
	}
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "\"ambulancias\"";
	}
	...
	public function insert(&$rs)
	{
		...
		if ($success) {
			...
			$this->id_ambulancias->setDbValue($conn->getOne("SELECT currval('ambulancias_id_ambulancias_seq'::regclass)"));
			$rs['id_ambulancias'] = $this->id_ambulancias->DbValue;
		}
		return $success;
	}
	...
	public function update(&$rs, $where = "", $rsold = NULL, $curfilter = TRUE)
	{
		...
		// Cascade Update detail table 'mante_amb'
		$cascadeUpdate = FALSE;
		$rscascade = [];
		if ($rsold && (isset($rs['id_ambulancias']) && $rsold['id_ambulancias'] != $rs['id_ambulancias'])) { // Update detail field 'id_ambulancias'
			$cascadeUpdate = TRUE;
			$rscascade['id_ambulancias'] = $rs['id_ambulancias'];
		}
		if ($cascadeUpdate) {
			if (!isset($GLOBALS["mante_amb"]))
				$GLOBALS["mante_amb"] = new mante_amb();
			$rswrk = $GLOBALS["mante_amb"]->loadRs("\"id_ambulancias\" = " . QuotedValue($rsold['id_ambulancias'], DATATYPE_NUMBER, 'DB'));
			while ($rswrk && !$rswrk->EOF) {
				...
				$success = $GLOBALS["mante_amb"]->Row_Updating($rsdtlold, $rsdtlnew);
				if ($success)
					$success = $GLOBALS["mante_amb"]->update($rscascade, $rskey, $rswrk->fields);
				if (!$success)
					return FALSE;

				// Call Row_Updated event
				$GLOBALS["mante_amb"]->Row_Updated($rsdtlold, $rsdtlnew);
				$rswrk->moveNext();
			}
		}
	...
	public function delete(&$rs, $where = "", $curfilter = FALSE)
	{
		...
		// Cascade delete detail table 'mante_amb'
		if (!isset($GLOBALS["mante_amb"]))
			$GLOBALS["mante_amb"] = new mante_amb();
		$rscascade = $GLOBALS["mante_amb"]->loadRs("\"id_ambulancias\" = " . QuotedValue($rs['id_ambulancias'], DATATYPE_NUMBER, "DB"));
		$dtlrows = ($rscascade) ? $rscascade->getRows() : [];

		// Call Row Deleting event
		foreach ($dtlrows as $dtlrow) {
			$success = $GLOBALS["mante_amb"]->Row_Deleting($dtlrow);
			if (!$success)
				break;
		}
		if ($success) {
			foreach ($dtlrows as $dtlrow) {
				$success = $GLOBALS["mante_amb"]->delete($dtlrow); // Delete
				if (!$success)
					break;
			}
		}
		...
		if ($success) {
			foreach ($dtlrows as $dtlrow)
				$GLOBALS["mante_amb"]->Row_Deleted($dtlrow);
		}
		if ($success)
	...
	{
		return "\"id_ambulancias\" = @id_ambulancias@";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "ambulanciasedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "ambulanciasadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("ambulanciasview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("ambulanciasview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "ambulanciasadd.php?" . $this->getUrlParm($parm);
		else
			$url = "ambulanciasadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("ambulanciasedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("ambulanciasedit.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("ambulanciasadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("ambulanciasadd.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("ambulanciasdelete.php", $this->getUrlParm());
	}
	...
	public function getFilterFromRecordKeys($setCurrent = TRUE)
	{
		...
		foreach ($arKeys as $key) {
			...
			if ($setCurrent)
				$this->id_ambulancias->CurrentValue = $key;
			else
				$this->id_ambulancias->OldValue = $key;
	...
	public function renderEditRow()
	{
		...
		$this->fecha_iniseguro->EditValue = FormatDateTime($this->fecha_iniseguro->CurrentValue, 5);
		...
		$this->fecha_finseguro->EditValue = FormatDateTime($this->fecha_finseguro->CurrentValue, 5);
