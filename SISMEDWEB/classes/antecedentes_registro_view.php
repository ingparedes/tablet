 ...
 * Page class
 */
class antecedentes_registro_view extends antecedentes_registro
{
	...
	// Page object name
	public $PageObjName = "antecedentes_registro_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "antecedentes_registrolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "antecedentes_registrolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "antecedentes_registrolist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
