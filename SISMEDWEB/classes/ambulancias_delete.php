 ...
 * Page class
 */
class ambulancias_delete extends ambulancias
{
	...
	// Page object name
	public $PageObjName = "ambulancias_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ambulanciaslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ambulanciaslist.php"); // Return to list
			}
		}
	}
