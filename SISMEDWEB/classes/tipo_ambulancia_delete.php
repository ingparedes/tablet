 ...
 * Page class
 */
class tipo_ambulancia_delete extends tipo_ambulancia
{
	...
	// Page object name
	public $PageObjName = "tipo_ambulancia_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tipo_ambulancialist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("tipo_ambulancialist.php"); // Return to list
			}
		}
	}
