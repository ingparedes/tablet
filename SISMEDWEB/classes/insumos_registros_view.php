 ...
 * Page class
 */
class insumos_registros_view extends insumos_registros
{
	...
	// Page object name
	public $PageObjName = "insumos_registros_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "insumos_registroslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "insumos_registroslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "insumos_registroslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
