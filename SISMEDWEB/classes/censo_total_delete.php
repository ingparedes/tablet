 ...
 * Page class
 */
class censo_total_delete extends censo_total
{
	...
	// Page object name
	public $PageObjName = "censo_total_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("censo_totallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("censo_totallist.php"); // Return to list
			}
		}
	}
