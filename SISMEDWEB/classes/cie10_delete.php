 ...
 * Page class
 */
class cie10_delete extends cie10
{
	...
	// Page object name
	public $PageObjName = "cie10_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("cie10list.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("cie10list.php"); // Return to list
			}
		}
	}
