 ...
 * Page class
 */
class modalidad_ambulancia_view extends modalidad_ambulancia
{
	...
	// Page object name
	public $PageObjName = "modalidad_ambulancia_view";
	...
	public function __construct()
	{
		...
		if (Get("id_modalidad") !== NULL) {
			$this->RecKey["id_modalidad"] = Get("id_modalidad");
			$keyUrl .= "&amp;id_modalidad=" . urlencode($this->RecKey["id_modalidad"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_modalidad") !== NULL) {
				...
				$this->RecKey["id_modalidad"] = $this->id_modalidad->QueryStringValue;
				...
				$this->RecKey["id_modalidad"] = $this->id_modalidad->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_modalidad->setFormValue(Route(2));
				$this->RecKey["id_modalidad"] = $this->id_modalidad->FormValue;
			} else {
				$returnUrl = "modalidad_ambulancialist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "modalidad_ambulancialist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "modalidad_ambulancialist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
