...
class userlevels extends DbTable
{
	...
	public function __construct()
	{
		...
		// userlevelid
		$this->userlevelid = new DbField('userlevels', 'userlevels', 'x_userlevelid', 'userlevelid', '"userlevelid"', 'CAST("userlevelid" AS varchar(255))', 3, 4, -1, FALSE, '"userlevelid"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
