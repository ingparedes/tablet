...
/**
 * Table class for interh_map
 */
class interh_map extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'interh_map';
		$this->TableName = 'interh_map';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "\"interh_map\"";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// latitud_hospital
		$this->latitud_hospital = new DbField('interh_map', 'interh_map', 'x_latitud_hospital', 'latitud_hospital', '"latitud_hospital"', '"latitud_hospital"', 200, 30, -1, FALSE, '"latitud_hospital"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->latitud_hospital->Sortable = TRUE; // Allow sort
		$this->fields['latitud_hospital'] = &$this->latitud_hospital;

		// longitud_hospital
		$this->longitud_hospital = new DbField('interh_map', 'interh_map', 'x_longitud_hospital', 'longitud_hospital', '"longitud_hospital"', '"longitud_hospital"', 200, 30, -1, FALSE, '"longitud_hospital"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->longitud_hospital->Sortable = TRUE; // Allow sort
		$this->fields['longitud_hospital'] = &$this->longitud_hospital;

		// tipo
		$this->tipo = new DbField('interh_map', 'interh_map', 'x_tipo', 'tipo', '"tipo"', '"tipo"', 201, 0, -1, FALSE, '"tipo"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->tipo->Sortable = TRUE; // Allow sort
		$this->fields['tipo'] = &$this->tipo;

		// nombre_hospital
		$this->nombre_hospital = new DbField('interh_map', 'interh_map', 'x_nombre_hospital', 'nombre_hospital', '"nombre_hospital"', '"nombre_hospital"', 200, 100, -1, FALSE, '"nombre_hospital"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->nombre_hospital->Sortable = TRUE; // Allow sort
		$this->fields['nombre_hospital'] = &$this->nombre_hospital;

		// nivel_hospital
		$this->nivel_hospital = new DbField('interh_map', 'interh_map', 'x_nivel_hospital', 'nivel_hospital', '"nivel_hospital"', '"nivel_hospital"', 200, 100, -1, FALSE, '"nivel_hospital"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nivel_hospital->Sortable = TRUE; // Allow sort
		$this->fields['nivel_hospital'] = &$this->nivel_hospital;

		// icon_hospital
		$this->icon_hospital = new DbField('interh_map', 'interh_map', 'x_icon_hospital', 'icon_hospital', '"icon_hospital"', '"icon_hospital"', 200, 0, -1, FALSE, '"icon_hospital"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->icon_hospital->Sortable = TRUE; // Allow sort
		$this->fields['icon_hospital'] = &$this->icon_hospital;

		// estado
		$this->estado = new DbField('interh_map', 'interh_map', 'x_estado', 'estado', '"estado"', 'CAST("estado" AS varchar(255))', 2, 2, -1, FALSE, '"estado"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "\"interh_map\"";
	}
	...
	{
		return ($this->SqlOrderBy != "") ? $this->SqlOrderBy : "\"estado\" ASC";
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->icon_hospital->DbValue = $row['icon_hospital'];
	...
	{
		global $Language;
		if ($pageName == "interh_mapview.php")
			return $Language->phrase("View");
		elseif ($pageName == "interh_mapedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "interh_mapadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("interh_mapview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("interh_mapview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "interh_mapadd.php?" . $this->getUrlParm($parm);
		else
			$url = "interh_mapadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("interh_mapedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("interh_mapadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("interh_mapdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->icon_hospital->setDbValue($rs->fields('icon_hospital'));
	...
	public function renderEditRow()
	{
		...
		if (!$this->icon_hospital->Raw)
			$this->icon_hospital->CurrentValue = HtmlDecode($this->icon_hospital->CurrentValue);
		$this->icon_hospital->EditValue = $this->icon_hospital->CurrentValue;
		$this->icon_hospital->PlaceHolder = RemoveHtml($this->icon_hospital->caption());
