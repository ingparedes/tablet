 ...
 * Page class
 */
class cie10dx_delete extends cie10dx
{
	...
	// Page object name
	public $PageObjName = "cie10dx_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("cie10dxlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("cie10dxlist.php"); // Return to list
			}
		}
	}
