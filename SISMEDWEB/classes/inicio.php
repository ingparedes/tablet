...
class inicio
{
	...
	// Table name
	public $TableName = 'inicio.php';

	// Page object name
	public $PageObjName = "inicio";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'inicio.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "inicio", $url, "", "inicio", TRUE);
		$this->Heading = $Language->TablePhrase("inicio", "TblCaption"); 
	}
} // End class
?>