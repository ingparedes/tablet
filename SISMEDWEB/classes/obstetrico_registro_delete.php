 ...
 * Page class
 */
class obstetrico_registro_delete extends obstetrico_registro
{
	...
	// Page object name
	public $PageObjName = "obstetrico_registro_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("obstetrico_registrolist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("obstetrico_registrolist.php"); // Return to list
			}
		}
	}
