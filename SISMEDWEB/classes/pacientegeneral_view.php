 ...
 * Page class
 */
class pacientegeneral_view extends pacientegeneral
{
	...
	// Page object name
	public $PageObjName = "pacientegeneral_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("cod_casointerh") !== NULL) {
				...
				$returnUrl = "pacientegenerallist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "pacientegenerallist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "pacientegenerallist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
