 ...
 * Page class
 */
class preh_despacho_view extends preh_despacho
{
	...
	// Page object name
	public $PageObjName = "preh_despacho_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("cod_casopreh") !== NULL) {
				...
				$returnUrl = "preh_despacholist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "preh_despacholist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "preh_despacholist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
