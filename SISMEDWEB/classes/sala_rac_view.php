 ...
 * Page class
 */
class sala_rac_view extends sala_rac
{
	...
	// Page object name
	public $PageObjName = "sala_rac_view";
	...
	public function __construct()
	{
		...
		if (Get("id_registro") !== NULL) {
			$this->RecKey["id_registro"] = Get("id_registro");
			$keyUrl .= "&amp;id_registro=" . urlencode($this->RecKey["id_registro"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_registro") !== NULL) {
				...
				$this->RecKey["id_registro"] = $this->id_registro->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->id_registro->setQueryStringValue(Key(0));
				$this->RecKey["id_registro"] = $this->id_registro->QueryStringValue;
			} elseif (Post("id_registro") !== NULL) {
				$this->id_registro->setFormValue(Post("id_registro"));
				$this->RecKey["id_registro"] = $this->id_registro->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_registro->setFormValue(Route(2));
				$this->RecKey["id_registro"] = $this->id_registro->FormValue;
			} else {
				$returnUrl = "sala_raclist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "sala_raclist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "sala_raclist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
