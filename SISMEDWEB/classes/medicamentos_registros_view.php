 ...
 * Page class
 */
class medicamentos_registros_view extends medicamentos_registros
{
	...
	// Page object name
	public $PageObjName = "medicamentos_registros_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "medicamentos_registroslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "medicamentos_registroslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "medicamentos_registroslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
