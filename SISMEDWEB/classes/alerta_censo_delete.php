 ...
 * Page class
 */
class alerta_censo_delete extends alerta_censo
{
	...
	// Page object name
	public $PageObjName = "alerta_censo_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("alerta_censolist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("alerta_censolist.php"); // Return to list
			}
		}
	}
