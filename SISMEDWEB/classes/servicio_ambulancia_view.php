 ...
 * Page class
 */
class servicio_ambulancia_view extends servicio_ambulancia
{
	...
	// Page object name
	public $PageObjName = "servicio_ambulancia_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("cod_casointerh") !== NULL) {
				...
				$returnUrl = "servicio_ambulancialist.php"; // Return to list
			}
			if (Get("cod_ambulancia") !== NULL) {
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "servicio_ambulancialist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "servicio_ambulancialist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
