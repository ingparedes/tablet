 ...
 * Page class
 */
class turno_registro_view extends turno_registro
{
	...
	// Page object name
	public $PageObjName = "turno_registro_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "turno_registrolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "turno_registrolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "turno_registrolist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
