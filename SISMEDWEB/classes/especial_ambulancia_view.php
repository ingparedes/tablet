 ...
 * Page class
 */
class especial_ambulancia_view extends especial_ambulancia
{
	...
	// Page object name
	public $PageObjName = "especial_ambulancia_view";
	...
	public function __construct()
	{
		...
		if (Get("id_especialambulancia") !== NULL) {
			$this->RecKey["id_especialambulancia"] = Get("id_especialambulancia");
			$keyUrl .= "&amp;id_especialambulancia=" . urlencode($this->RecKey["id_especialambulancia"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_especialambulancia") !== NULL) {
				...
				$this->RecKey["id_especialambulancia"] = $this->id_especialambulancia->QueryStringValue;
				...
				$this->RecKey["id_especialambulancia"] = $this->id_especialambulancia->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_especialambulancia->setFormValue(Route(2));
				$this->RecKey["id_especialambulancia"] = $this->id_especialambulancia->FormValue;
			} else {
				$returnUrl = "especial_ambulancialist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "especial_ambulancialist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "especial_ambulancialist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
