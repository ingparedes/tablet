 ...
 * Page class
 */
class servicio_ambulancia_delete extends servicio_ambulancia
{
	...
	// Page object name
	public $PageObjName = "servicio_ambulancia_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("servicio_ambulancialist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("servicio_ambulancialist.php"); // Return to list
			}
		}
	}
