 ...
 * Page class
 */
class firmas_registro_view extends firmas_registro
{
	...
	// Page object name
	public $PageObjName = "firmas_registro_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "firmas_registrolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "firmas_registrolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "firmas_registrolist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
