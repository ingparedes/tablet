 ...
 * Page class
 */
class especial_ambulancia_addopt extends especial_ambulancia
{
	...
	// Page object name
	public $PageObjName = "especial_ambulancia_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->especial_es->IsDetailKey) {
			$this->especial_es->setFormValue(ConvertFromUtf8($val));
		}
		...
		if (!$this->especial_en->IsDetailKey) {
			$this->especial_en->setFormValue(ConvertFromUtf8($val));
		}
		...
		if (!$this->especial_pr->IsDetailKey) {
			$this->especial_pr->setFormValue(ConvertFromUtf8($val));
		}
		...
		if (!$this->especial_fr->IsDetailKey) {
			$this->especial_fr->setFormValue(ConvertFromUtf8($val));
		}
	...
	{
		global $CurrentForm;
		$this->especial_es->CurrentValue = ConvertToUtf8($this->especial_es->FormValue);
		$this->especial_en->CurrentValue = ConvertToUtf8($this->especial_en->FormValue);
		$this->especial_pr->CurrentValue = ConvertToUtf8($this->especial_pr->FormValue);
		$this->especial_fr->CurrentValue = ConvertToUtf8($this->especial_fr->FormValue);
	}
