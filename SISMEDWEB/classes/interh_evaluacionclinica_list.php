 ...
 * Page class
 */
class interh_evaluacionclinica_list extends interh_evaluacionclinica
{
	...
	// Page object name
	public $PageObjName = "interh_evaluacionclinica_list";

	// Grid form hidden field names
	public $FormName = "finterh_evaluacionclinicalist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "interh_evaluacionclinicaadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "interh_evaluacionclinicadelete.php";
		$this->MultiUpdateUrl = "interh_evaluacionclinicaupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option finterh_evaluacionclinicalistsrch";
	...
	public function run()
	{
		...
		$this->sv_fr->Visible = FALSE;
		$this->sv_temp->Visible = FALSE;
		$this->sv_gl->setVisibility();
		$this->peso->Visible = FALSE;
		$this->talla->Visible = FALSE;
		$this->sv_fcf->Visible = FALSE;
		$this->sv_satO2->Visible = FALSE;
		$this->sv_apgar->Visible = FALSE;
		$this->sv_gli->Visible = FALSE;
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"finterh_evaluacionclinicalistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"finterh_evaluacionclinicalistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.finterh_evaluacionclinicalist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
