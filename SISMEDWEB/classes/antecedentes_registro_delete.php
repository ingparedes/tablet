 ...
 * Page class
 */
class antecedentes_registro_delete extends antecedentes_registro
{
	...
	// Page object name
	public $PageObjName = "antecedentes_registro_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("antecedentes_registrolist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("antecedentes_registrolist.php"); // Return to list
			}
		}
	}
