 ...
 * Page class
 */
class recordatorio_taller_view extends recordatorio_taller
{
	...
	// Page object name
	public $PageObjName = "recordatorio_taller_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "recordatorio_tallerlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "recordatorio_tallerlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "recordatorio_tallerlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
