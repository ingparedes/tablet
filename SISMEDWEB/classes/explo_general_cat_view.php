 ...
 * Page class
 */
class explo_general_cat_view extends explo_general_cat
{
	...
	// Page object name
	public $PageObjName = "explo_general_cat_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "explo_general_catlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "explo_general_catlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "explo_general_catlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
