 ...
 * Page class
 */
class sala_admision_view extends sala_admision
{
	...
	// Page object name
	public $PageObjName = "sala_admision_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("cod_casopreh") !== NULL) {
				...
				$returnUrl = "sala_admisionlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "sala_admisionlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "sala_admisionlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
