 ...
 * Page class
 */
class censo_camas_delete extends censo_camas
{
	...
	// Page object name
	public $PageObjName = "censo_camas_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("censo_camaslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("censo_camaslist.php"); // Return to list
			}
		}
	}
