 ...
 * Page class
 */
class bloques_div_view extends bloques_div
{
	...
	// Page object name
	public $PageObjName = "bloques_div_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "bloques_divlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "bloques_divlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "bloques_divlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
