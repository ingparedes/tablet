 ...
 * Page class
 */
class recordatorio_taller_delete extends recordatorio_taller
{
	...
	// Page object name
	public $PageObjName = "recordatorio_taller_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("recordatorio_tallerlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("recordatorio_tallerlist.php"); // Return to list
			}
		}
	}
