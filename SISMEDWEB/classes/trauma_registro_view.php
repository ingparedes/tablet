 ...
 * Page class
 */
class trauma_registro_view extends trauma_registro
{
	...
	// Page object name
	public $PageObjName = "trauma_registro_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "trauma_registrolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "trauma_registrolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "trauma_registrolist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
