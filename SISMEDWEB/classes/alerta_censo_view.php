 ...
 * Page class
 */
class alerta_censo_view extends alerta_censo
{
	...
	// Page object name
	public $PageObjName = "alerta_censo_view";
	...
	public function __construct()
	{
		...
		if (Get("id_tiempocenso") !== NULL) {
			$this->RecKey["id_tiempocenso"] = Get("id_tiempocenso");
			$keyUrl .= "&amp;id_tiempocenso=" . urlencode($this->RecKey["id_tiempocenso"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_tiempocenso") !== NULL) {
				...
				$this->RecKey["id_tiempocenso"] = $this->id_tiempocenso->QueryStringValue;
				...
				$this->RecKey["id_tiempocenso"] = $this->id_tiempocenso->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_tiempocenso->setFormValue(Route(2));
				$this->RecKey["id_tiempocenso"] = $this->id_tiempocenso->FormValue;
			} else {
				$returnUrl = "alerta_censolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "alerta_censolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "alerta_censolist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
