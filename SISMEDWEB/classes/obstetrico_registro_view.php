 ...
 * Page class
 */
class obstetrico_registro_view extends obstetrico_registro
{
	...
	// Page object name
	public $PageObjName = "obstetrico_registro_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "obstetrico_registrolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "obstetrico_registrolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "obstetrico_registrolist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
