 ...
 * Page class
 */
class modalidad_ambulancia_delete extends modalidad_ambulancia
{
	...
	// Page object name
	public $PageObjName = "modalidad_ambulancia_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("modalidad_ambulancialist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("modalidad_ambulancialist.php"); // Return to list
			}
		}
	}
