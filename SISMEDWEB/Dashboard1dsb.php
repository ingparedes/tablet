  ...
  <div class="row">
		  ...
		  <div class="col-12 col-sm-6 col-md-3">
			<div class="info-box mb-3">
			  ...
			  <div class="info-box-content">
				<span class="info-box-text">Cases in Hospital</span>
...
?>
	...
	<div class="col-lg-4">
		<div class="card">
		   ...
		   <div class="card-body">
<?php
$r2->Prioridad->Width = 200;
$r2->Prioridad->Height = 200;
$r2->Prioridad->setParameter("clickurl", "r2smry.php"); // Add click URL
$r2->Prioridad->DrillDownUrl = ""; // No drill down for dashboard
$r2->Prioridad->render("ew-chart-top");
?>
</div>
		</div>
	</div>	
...
?>
		...
		<div class="card">
			...
			<div class="card-body">
<?php
$interh_hospitales->Hospital_receptor->Width = 200;
$interh_hospitales->Hospital_receptor->Height = 200;
$interh_hospitales->Hospital_receptor->setParameter("clickurl", "interh_hospitalessmry.php"); // Add click URL
$interh_hospitales->Hospital_receptor->DrillDownUrl = ""; // No drill down for dashboard
$interh_hospitales->Hospital_receptor->render("ew-chart-top");
?>
</div>
		</div>
		<div class="card">
