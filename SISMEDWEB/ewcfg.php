...
$CONFIG = [
	...
	"RANDOM_KEY" => 'hO8v1PE0Ke43z4j3', // Random key for encryption
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "POSTGRESQL", "qs" => "\"", "qe" => "\"", "host" => "190.85.49.114", "port" => 12750, "user" => "dba_sismed", "pass" => "Sismed@2020*", "db" => "sismed911", "schema" => "public"]
	],
