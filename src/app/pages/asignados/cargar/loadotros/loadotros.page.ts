...
export class LoadotrosPage implements OnInit {
  ...
  constructor(private alertController: AlertController, 
    private plt: Platform, private dataService: DataService, 
  ...
  ngOnInit() {
    ...
    setTimeout(() => {
      this.medico = this.dataService.medico
      this.dhospistal = this.dataService.Hospital
      ...
      buttons: [
        {
          ...
          handler: () => {
            ...
            this.dataService.setOthers(this.desc, this.nombre_confirma, this.telefono_confirma, this.kfinal, this.hospistal, this.medico, this.obscaso, this.cierre)
